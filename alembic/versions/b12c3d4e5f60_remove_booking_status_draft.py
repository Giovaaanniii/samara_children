...
def upgrade() -> None:
    ...
    op.execute('ALTER TABLE bookings ALTER COLUMN status TYPE booking_status_new USING status::text::booking_status_new')
...
def downgrade() -> None:
    ...
    op.execute('ALTER TABLE bookings ALTER COLUMN status TYPE booking_status_old USING status::text::booking_status_old')
    op.execute('DROP TYPE booking_status')
